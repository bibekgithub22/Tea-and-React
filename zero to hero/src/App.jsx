  ...
  return (
    <div className="duration-150" style={{ backgroundColor: color }}>
      <div className=" py-10 pt-24 ">
        <h1 className="text-3xl font-bold text-center pb-5 drop-shadow-sm">
          Hello world!
        </h1>
        <h2 className="text-center text-2xl drop-shadow-sm">
          Welcome to React!
        </h2>
      </div>

      <div className="flex flex-col  items-center gap-5">
        <h1 className="text-xl">Count : {counter}</h1>
        <p className="text-slate-400">Range 0~10</p>
        <button
          onClick={addCounter}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-14 gap-x-10 pb-10">
        ...
        <Cards title="Shallow" para="" img="./public/Images/5.jpg" />
        <Cards title="Amuse" para="" img="./public/Images/6.jpg" />
      </div>

      <div className="fixed flex flex-wrap justify-around items-center top-12 inset-x-0 px-2 rounded ">
